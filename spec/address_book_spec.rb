 ...
 RSpec.describe AddressBook do
   ...
   describe "#add_entry" do
    ...
    describe "#remove_entry" do
       it "removes only one entry from the address book" do
         book.add_entry('Ada Lovelace', '010.012.1815', 'augusta.king@lovelace.com')
         book.add_entry('Grace Hopper', '555.555.1000', 'rearadmiral@navy.com')
       ...
       it "removes the correct entry from entries" do
         ...
         only_entry = book.entries[0]

         expect(only_entry.name).to eq('Grace Hopper')
         expect(only_entry.phone_number).to eq('555.555.1000')
         expect(only_entry.email).to eq('rearadmiral@navy.com')
       end
     end
   ...
   describe "#import_from_csv2" do
    ...
    describe "#binary_search" do
     ...
     it "searches AddressBook for Billi" do
       book.import_from_csv("entries.csv")
